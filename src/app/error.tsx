    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-w-xl mx-auto">
              We're experiencing a technical issue on our end. Our medical team is working to resolve this 
              as quickly as possible. Please try again in a moment.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-6">
            ...
            <p className="text-gray-600 mb-4">
              If this error persists or you need urgent medical assistance, please contact us directly.
            </p>
              ...
              <div className="flex items-center justify-center p-3 bg-white rounded-lg">
                ...
                <div className="text-left">
                  ...
                  <a 
                    ...
                    className="font-medium text-medical-primary-600 hover:text-medical-primary-700 transition-colors"
                  >
                    {doctorData.phone}
                  </a>
                </div>
        ...
        <div className="text-center mt-6 text-gray-500 text-sm">
          <p>
            We apologize for any inconvenience. Our technical team has been notified of this issue.
          </p>
        </div>
